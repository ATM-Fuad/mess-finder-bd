// ─────────────────────────────────────────────────
//  SavedMesses.js → BookmarkedMesses
//  Feature 3: Heart → Bookmark icon & language
// ─────────────────────────────────────────────────
  ...
  if (!currentUser) {
    return (
      <div className="text-center py-20">
        ...
        <h2 className="text-xl font-bold text-gray-800 mb-2">Login to see bookmarks</h2>
        <p className="text-gray-500 mb-6">
          Bookmark messes by tapping 🔖 on any listing
        </p>
        <button
    ...
    <div className="pb-24 md:pb-6">
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-500 text-sm mt-1">
          Messes you bookmarked — tap 🔖 on a listing to remove
        </p>
      </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-16 bg-white rounded-2xl border border-dashed border-gray-200">
          ...
          <p className="text-gray-400 mb-6 text-sm">
            Browse messes and tap 🔖 to save them here for later
          </p>
          <Link
            to="/"
            className="bg-orange-500 text-white px-6 py-3 rounded-xl font-semibold hover:bg-orange-600 transition-colors"
